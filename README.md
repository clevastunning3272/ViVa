...
1.  Locate the downloaded file in your computer folder.
2.  Double-click the file to start the installer.
3.  A window might appear that asks for permission to make changes. Click Yes to proceed.
...
6.  Find the ViVa icon on your desktop or in your start menu.
7.  Click the icon to launch the program for the first time.
...
3.  Select your video files from your computer.
4.  ViVa calculates the movement patterns automatically.
5.  Wait for the progress bar to finish before you start the training phase.
...
2.  Set the Training Intensity to Medium for a first test.
3.  Click the Start Training button.
4.  The program shows a preview of its progress.
5.  When the status reaches Complete, the model is ready for export.
6.  Click Save Model to create the file you will load onto your robot.
...
**Can I run ViVa on a laptop?** 
Yes, provided your laptop has a dedicated graphics card. Integrated graphics chips do not have enough power to run the model.

**How much data do I need?** 
Ten minutes of clear video is enough for most simple tasks. Complex movements might require thirty minutes or more of footage.

**Where does ViVa save my final files?** 
The software saves all models in your Documents folder under a subfolder named ViVa Projects.

**Does this software work without the internet?** 
Yes. Once you install the program, you can use all features offline. You only need the internet to download the installer.

**Can I use different robot types?** 
Yes. The software exports files that work with most standard robot controllers. Ensure you format your final robot interface settings to match the export settings in the Train tab.